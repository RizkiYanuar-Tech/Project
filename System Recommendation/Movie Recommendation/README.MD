...
## PROJECT STRUCTURE
├── Garbage/
│   ├── All_Data/          # Dataset gabungan yang terorganisir per kelas
│   └── Augmented_Data/    # (Opsional) Hasil augmentasi gambar
├── Klasifikasi_Gambar.ipynb # Main Notebook (Training & Evaluation)
